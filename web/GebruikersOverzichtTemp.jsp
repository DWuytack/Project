                                ...
                                <tr>
                                    ...
                                    <c:if test="${sessionScope.currentSessionUser.rol == 'admin'}" >
                                        <td>
                                            ...
                                            <c:if test="${cursist.gebruikerID == sessionScope.editID}" >
                                                <input type="image"  name="idSave" value="${cursist.gebruikerID}" src='images/pencil.png'>
                                                <input type="image"  name="idCancel" value="${cursist.gebruikerID}" src='images/vuilbak.png'>
                                            </c:if>
                                        </td>
                                    </c:if>
                                </tr>
